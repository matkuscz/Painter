...
class AdressesControllerTest < ActionController::TestCase
  ...
  test "should create adress" do
    assert_difference('Adress.count') do
      post :create, adress: { city: @adress.city, country: @adress.country, description_number: @adress.description_number, postal_code: @adress.postal_code, street: @adress.street }
    end
  ...
  test "should update adress" do
    patch :update, id: @adress, adress: { city: @adress.city, country: @adress.country, description_number: @adress.description_number, postal_code: @adress.postal_code, street: @adress.street }
    assert_redirected_to adress_path(assigns(:adress))
  end
